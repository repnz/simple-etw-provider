...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Provider "Hello World Metric Provider" event count 1
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

// Provider GUID = 06a2ea53-fc6c-42e5-9176-18749ab2ca13
EXTERN_C __declspec(selectany) const GUID HELLO_METRIC = {0x06a2ea53, 0xfc6c, 0x42e5, {0x91, 0x76, 0x18, 0x74, 0x9a, 0xb2, 0xca, 0x13}};

#ifndef HELLO_METRIC_Traits
#define HELLO_METRIC_Traits NULL
#endif // HELLO_METRIC_Traits

//
// Event Descriptors
//
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR SIMPLE_METRIC = {0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0};
#define SIMPLE_METRIC_value 0x1
...
EXTERN_C __declspec(selectany) const unsigned char Hello_World_Metric_ProviderLevels[1] = {0};

//
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT HELLO_METRIC_Context = {0, (ULONG_PTR)HELLO_METRIC_Traits, 0, 0, 0, 0, 0, 0, 1, Hello_World_Metric_ProviderEnableBits, Hello_World_Metric_ProviderKeywords, Hello_World_Metric_ProviderLevels};

//
// Provider REGHANDLE
//
#define Hello_World_Metric_ProviderHandle (HELLO_METRIC_Context.RegistrationHandle)
...
//
#define HELLO_METRIC_EventWriteActivity 0
...
//
#ifndef EventRegisterHello_World_Metric_Provider
#define EventRegisterHello_World_Metric_Provider() McGenEventRegister(&HELLO_METRIC, McGenControlCallbackV2, &HELLO_METRIC_Context, &Hello_World_Metric_ProviderHandle)
#endif
...
//
#ifndef EventRegisterByGuidHello_World_Metric_Provider
#define EventRegisterByGuidHello_World_Metric_Provider(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &HELLO_METRIC_Context, &Hello_World_Metric_ProviderHandle)
#endif
...
//
#ifndef EventUnregisterHello_World_Metric_Provider
#define EventUnregisterHello_World_Metric_Provider() McGenEventUnregister(&Hello_World_Metric_ProviderHandle)
#endif

//
// Enablement check macro for SIMPLE_METRIC
//
#define EventEnabledSIMPLE_METRIC() MCGEN_EVENT_BIT_SET(Hello_World_Metric_ProviderEnableBits, 0)

//
// Event write macros for SIMPLE_METRIC
//
#define EventWriteSIMPLE_METRIC(metric_name, metric_value) \
        MCGEN_EVENT_ENABLED(SIMPLE_METRIC) \
        ? McTemplateU0zd(&HELLO_METRIC_Context, &SIMPLE_METRIC, metric_name, metric_value) : 0
#define EventWriteSIMPLE_METRIC_AssumeEnabled(metric_name, metric_value) \
        McTemplateU0zd(&HELLO_METRIC_Context, &SIMPLE_METRIC, metric_name, metric_value)
...
//
//
//Template from manifest : Simple Metric
//
#ifndef McTemplateU0zd_def
#define McTemplateU0zd_def
ETW_INLINE
ULONG
McTemplateU0zd(
    _In_ PMCGEN_TRACE_CONTEXT Context,
...
{
#define McTemplateU0zd_ARGCOUNT 2

    EVENT_DATA_DESCRIPTOR EventData[McTemplateU0zd_ARGCOUNT + 1];
    ...
    return McGenEventWrite(Context, Descriptor, NULL, McTemplateU0zd_ARGCOUNT + 1, EventData);
}
#endif // McTemplateU0zd_def
...
#define MSG_Hello_World_Metric_Provider_event_1_message 0xB0010001L
